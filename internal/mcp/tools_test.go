...
func TestServer_ToolCountAfterOutcomeFold(t *testing.T) {
	...
	require.Equal(t, 16, s.ToolCount(), "the implement profile registers its allow-set only: the always-on six, its 9 granted tools, and its submit_outcome (contract D.6)")
